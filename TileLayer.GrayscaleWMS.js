...
L.TileLayer.GrayscaleWMS = L.TileLayer.WMS.extend({
	options: {
		enableCanvas: true,
		quotaRed: 3,
		quotaGreen: 4,
	...
	_loadTile: function (tile, tilePoint) {
		...
		L.TileLayer.WMS.prototype._loadTile.call(this, tile, tilePoint);
	},
...
L.tileLayer.grayscalewms = function (url, options) {
	return new L.TileLayer.GrayscaleWMS(url, options);
};
